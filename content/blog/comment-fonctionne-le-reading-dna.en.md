...
themes: 47
complexity: 47
caption: Your Reading DNA in LinQfolio: a unique organic shape, where each dimension reflects your reading preferences (style, pace, structure, themes, complexity).
:::
...
:::octave
If you finished *One Hundred Years of Solitude* through gritted teeth, we should probably know before we suggest a bit of Faulkner.
:::
...
:::octave
Personally, I'm 100% Existentialist Monk. Mind you, that's easy — I only get through one book a year.
:::
...
- **Profile comparison.** Compare your Reading DNA with another reader's: the app computes your literary compatibility, dimension by dimension.

:::stats
meter: 87 | Compatibility with a book
tile: Recommendations | tuned to your taste
tile: Mystery Book | daily challenge | ?
caption: From Reading DNA to everyday use: a compatibility score shown before any read, recommendations tuned to your taste — and, for playful discovery, the daily Mystery Book challenge.
:::
...
What we don't do: sell your profile to third parties, make it public by default, or use it to target ads. The full details live in our [privacy policy](/confidentialite).

## In short

Three loved books, one to three abandoned, and you walk away with a layered reader profile: a dominant archetype out of twelve, a five-axis radar of preferences, a description of yourself as a reader. That profile evolves with every interaction and powers recommendations, compatibility scores, social sharing, and reader-to-reader profile comparison.
